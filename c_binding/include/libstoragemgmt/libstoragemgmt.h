 ...
 * @return LSM_ERR_OK on success else error reason.
 */
int LSM_DLL_EXPORT lsm_disk_set_ident_led(lsm_connect *c,
                                          lsm_disk *disk,
                                          lsm_flag flags);

/**
 * Clear the IDENT LED for the desired disk.
 * New in version 1.3, only available for hardware RAID and HBA cards.
 * @param[in] c				Valid connection
 * @param[in] disk			A single lsm_disk
 * @param[in] flags			Reserved, set to 0
 * @return LSM_ERR_OK on success else error reason.
 */
int LSM_DLL_EXPORT lsm_disk_clear_ident_led(lsm_connect *c,
                                            lsm_disk *disk,
                                            lsm_flag flags);
...
/**
 * Clear the FAULT LED for the desired disk.
 * New in version 1.3, only available for hardware RAID and HBA cards.
 * @param[in] c				Valid connection
 * @param[in] disk			A single lsm_disk
 * @param[in] flags			Reserved, set to 0
 * @return LSM_ERR_OK on success else error reason.
 */
int LSM_DLL_EXPORT lsm_disk_clear_fault_led(lsm_connect *c,
                                            lsm_disk *disk,
                                            lsm_flag flags);
