...
int lsm_disk_set_ident_led(lsm_connect * c, lsm_disk * disk,
                           lsm_flag flags)
{
    CONN_SETUP(c);
    ...
    int rc = rpc(c, "disk_set_ident_led", parameters, response);

    return rc;
}

int lsm_disk_clear_ident_led(lsm_connect * c, lsm_disk * disk,
                             lsm_flag flags)
{
    CONN_SETUP(c);
    ...
    int rc = rpc(c, "disk_clear_ident_led", parameters, response);

    return rc;
}

int lsm_disk_set_fault_led(lsm_connect * c, lsm_disk * disk,
                           lsm_flag flags)
{
    CONN_SETUP(c);
    ...
    int rc = rpc(c, "disk_set_fault_led", parameters, response);
